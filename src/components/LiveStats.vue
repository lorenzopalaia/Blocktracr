<template>
  <div class="container">
    <div class="row">
      <input
        type="text"
        class="form-control rounder-0 border-0 my-4 d-flex"
...
export default {
  ...
  data() {
    return {
      coins: [],
      filterCoins: [],
      titles: ["#", "Name", "Price", "24h%", "24h Vol", "Market Cap."],
      coinSearch: "",
    };
  },
  watch: {
  ...
  methods: {
    async getData() {
      let uri = "https://api.coingecko.com/api/v3/coins/markets?vs_currency=usd&order=market_cap_desc&per_page=100&page=" + this.$props.page;
